...
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=1G --time=3:00:00 --array=0-23%12 Ising_g_scaling.sh 8 $h 0.05 $fun $operator $site 1 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=1G --time=3:00:00 --array=0-23%12 Ising_g_scaling.sh 9 $h 0.05 $fun $operator $site 1 "${@:6}"
...
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=16 --mem=10G --time=96:00:00 --array=0-23%12 Ising_g_scaling.sh 13 $h 0.05 $fun $operator $site 16 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=16 --mem=20G --time=96:00:00 --array=0-23%8 Ising_g_scaling.sh 14 $h 0.05 $fun $operator $site 16 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=24 --mem=70G --time=168:00:00 --array=0-23%8 Ising_g_scaling.sh 15 $h 0.05 $fun $operator $site 24 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=32 --mem=100G --time=200:00:00 --array=0-23%8 Ising_g_scaling.sh 16 $h 0.05 $fun $operator $site 32 "${@:6}"
