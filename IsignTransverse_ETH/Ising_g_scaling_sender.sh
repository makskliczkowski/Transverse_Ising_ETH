...
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=1G --time=3:00:00 --array=0-29%2 Ising_g_scaling.sh 8 $h 0.05 $fun $operator $site 1 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=1G --time=3:00:00 --array=0-29%2 Ising_g_scaling.sh 9 $h 0.05 $fun $operator $site 1 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=2G --time=3:00:00 --array=0-29%2 Ising_g_scaling.sh 10 $h 0.05 $fun $operator $site 1 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=1 --mem=4G --time=3:00:00 --array=0-29%2 Ising_g_scaling.sh 11 $h 0.05 $fun $operator $site 1 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=4 --mem=6G --time=24:00:00 --array=0-29%2 Ising_g_scaling.sh 12 $h 0.05 $fun $operator $site 4 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=4 --mem=8G --time=96:00:00 --array=0-29%2 Ising_g_scaling.sh 13 $h 0.05 $fun $operator $site 4 "${@:6}"
sbatch --job-name=$name --output=logs/${name}_log-%A-%a.out --cpus-per-task=4 --mem=12G --time=96:00:00 --array=0-29%2 Ising_g_scaling.sh 14 $h 0.05 $fun $operator $site 4 "${@:6}"
