...
icc main.cpp IsingModel.cpp IsingModel_disorder.cpp IsingModel_sym.cpp tools.cpp user_interface.cpp -o Ising.o\
 -I../LIBRARIES_CPP/armadillo-10.8.2/include/ -pthread -lstdc++fs -qopenmp -qmkl=parallel -std=c++17 -O3

#g++ -m64 -fcx-fortran-rules -fomit-frame-pointer -std=c++20 -O3 -march=native\
# -pthread -fopenmp -I/home/rswietek/LIBRARIES_CPP/armadillo-10.8.2/include -L/home/rswietek/LIBRARIES_CPP/armadillo-10.8.2/lib64\
# -Wl,-rpath,/home/rswietek/LIBRARIES_CPP/armadillo-10.8.2/lib64 -larmadillo\
# -lpthread -lm -ldl -lstdc++fs\
# main.cpp IsingModel.cpp IsingModel_disorder.cpp IsingModel_sym.cpp tools.cpp user_interface.cpp -o Ising.o
